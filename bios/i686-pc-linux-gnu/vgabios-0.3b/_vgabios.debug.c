...
;;
  ...
  printf("VGABios $Id: _vgabios.debug.c,v 1.1.1.1 2003/09/25 03:12:52 fht Exp $\n");
}
...
.ascii       "$Id: _vgabios.debug.c,v 1.1.1.1 2003/09/25 03:12:52 fht Exp $"
.byte        0x00
...
#asm     
  ...
  printf("VBE Bios $Id: _vgabios.debug.c,v 1.1.1.1 2003/09/25 03:12:52 fht Exp $\n");
...
Bit16u *AX;Bit16u BX;Bit16u CX;Bit16u DX;
{
	...
	if ((( BX & 0x00ff ) ==0x00) || (( BX & 0x00ff ) ==0x80))
	{
