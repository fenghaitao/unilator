...
#define pci_io_read_long(x)		read_long(0x00000000 + (x))
#define pci_io_read_word(x)		read_word(0x00000000 + (x))
#define pci_io_read_byte(x)		read_byte(0x00000000 + (x))

#define pci_io_write_long(d,x)		write_long((d), 0x00000000 + (x))
#define pci_io_write_word(d,x)		write_word((d), 0x00000000 + (x))
#define pci_io_write_byte(d,x)		write_byte((d), 0x00000000 + (x))
