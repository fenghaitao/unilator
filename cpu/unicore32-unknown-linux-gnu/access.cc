/////////////////////////////////////////////////////////////////////////
// $Id: access.cc,v 1.1.1.1 2003/09/25 03:12:53 fht Exp $
/////////////////////////////////////////////////////////////////////////
//
...
#define LPFOf(laddr) ((laddr) & 0xfffff000)
  ...
  void
BX_CPU_C::write_virtual_checks(bx_address laddr,
                               unsigned length)
{
  Bit32u upper_limit;
  ...
  void
BX_CPU_C::read_virtual_checks(bx_address laddr,
                              unsigned length)
{
  Bit32u upper_limit;
#if 0
...
*/
  ...
  void
BX_CPU_C::write_virtual_byte(bx_address laddr, Bit8u *data)
{
...
accessOK:
  ...
  write_virtual_checks(laddr, 1);
  goto accessOK;
}

  void
BX_CPU_C::write_virtual_word(bx_address laddr, Bit16u *data)
{
...
accessOK:
  ...
  write_virtual_checks(laddr, 2);
  goto accessOK;
}

  void
BX_CPU_C::write_virtual_dword(bx_address laddr, Bit32u *data)
{
...
/* debugging */
  ...
  write_virtual_checks(laddr,4);
  goto accessOK;
}


  void
BX_CPU_C::read_virtual_byte(bx_address laddr, Bit8u *data)
{
...
accessOK:
  ...
  read_virtual_checks(laddr, 1);
  goto accessOK;
}


  void
BX_CPU_C::read_virtual_word(bx_address laddr, Bit16u *data)
{
...
accessOK:
  ...
  read_virtual_checks(laddr, 2);
  goto accessOK;
}


  void
BX_CPU_C::read_virtual_dword(bx_address laddr, Bit32u *data)
{
  if (1) {
    if (1) {
      unsigned pl;
...
BX_CPU_C::write_RMW_virtual_dword(Bit32u val32)
{
  ...
  void
BX_CPU_C::write_virtual_qword(bx_address laddr, Bit64u *data)
{
  if (1) {
    if (1) {
      unsigned pl;
accessOK:
  ...
  write_virtual_checks(laddr, 8);
  goto accessOK;
}


  void
BX_CPU_C::read_virtual_qword(bx_address laddr, Bit64u *data)
{
  if (1) {
    if (1) {
      unsigned pl;
