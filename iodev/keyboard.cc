/////////////////////////////////////////////////////////////////////////
// $Id: keyboard.cc,v 1.3 2003/11/12 08:41:06 fht Exp $
/////////////////////////////////////////////////////////////////////////
//
...
bx_keyb_c::init(void)
{
  BX_DEBUG(("Init $Id: keyboard.cc,v 1.3 2003/11/12 08:41:06 fht Exp $"));
  Bit32u   i;
...
BX_PANIC(("kbd: OUTB set and command 0x%02x encountered", value));
	  ...
	  for (int i=0; i<BX_SMP_PROCESSORS; i++) 
	    //future we will make multiple cpus plugin	
