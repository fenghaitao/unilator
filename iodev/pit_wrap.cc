////////////////////////////////////////////////////////////////////////
// $Id: pit_wrap.cc,v 1.2 2003/11/04 09:43:03 fht Exp $
/////////////////////////////////////////////////////////////////////////
//
...
bx_pit_c::init( void )
{
  ...
  if (BX_PIT_THIS s.timer_handle[0] == BX_NULL_TIMER_HANDLE) {
    BX_PIT_THIS s.timer_handle[0] = bx_pc_system.register_timer(this, timer_handler, (unsigned) 1000 , 1, 1, "pit_wrap");
  }
...
bx_pit_c::handle_timer() {
  ...
  //Bit32u time_passed32 = time_passed;
  //BX_INFO(("pit: entering timer handler time_passed is %d\n",time_passed));
                ...
                unsigned int io_len )
{
  ...
  //BX_INFO(("pit: entering write handler time_passed is %d\n",time_passed));
