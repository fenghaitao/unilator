/////////////////////////////////////////////////////////////////////////
// $Id: misc_mem.cc,v 1.2 2003/11/04 09:43:04 fht Exp $
/////////////////////////////////////////////////////////////////////////
//
...
BX_MEM_C::alloc_vector_aligned (size_t bytes, size_t alignment)
{
  ...
  Bit64u masked =(Bit64u) ((Bit64u) actual_vector + test_mask) & ~test_mask;
  vector = (Bit8u *)masked;
...
{
	BX_DEBUG(("Init $Id: misc_mem.cc,v 1.2 2003/11/04 09:43:04 fht Exp $"));
...
int
libmemory_LTX_plugin_init(plugin_t *plugin, plugintype_t type, int argc, char *argv[])
{
  bx_memsys.pluginMem = &bx_mem;
  return(0); // Success
}
