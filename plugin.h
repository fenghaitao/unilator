/////////////////////////////////////////////////////////////////////////
// $Id: plugin.h,v 1.1.1.1 2003/09/25 03:12:51 fht Exp $
/////////////////////////////////////////////////////////////////////////
//
...
#define DEV_init_devices() {bx_devices.init(&bx_memsys); }
...
//    void (*device_init_mem)(BX_MEM_C *);
    void (*device_init_mem)(bx_memsys_c *);
...
typedef void (*deviceInitMem_t)(bx_memsys_c *);
...
/* making cpu plugin 2004-02-24*/  
DECLARE_PLUGIN_INIT_FINI_FOR_MODULE(cpu)
/* making memory plugin 2004-02-24*/  
DECLARE_PLUGIN_INIT_FINI_FOR_MODULE(memory)
/* making mmu plugin 2004-02-24*/  
DECLARE_PLUGIN_INIT_FINI_FOR_MODULE(mmu)
